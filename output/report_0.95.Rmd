...
Using a 0.05% rule did not adjust the median removal date (Table \@ref(tab:remove05-koot)), and did not improve the chance that the majority of the run was observed (Table \@ref(tab:chance05-koot)).
