...
The objectives of this analysis were to:  
  ...
  4. For alternate runs (i.e. changes to the x% of the escapment 95% of the time on average), in the functions code, change the f_run_through function perc to desired percentage and change the f_pred_plot function perc to the desired percentage.
...
```{r risk05-koot, fig.cap="The percent of the run that will be missed at a given risk level, e.g., 7\\% of the run will be missed 5\\% of the time using a five day 0.05\\% rule for the Chilkoot River."}
...
The reason for this is that the run past the 90% removal date occurs in daily numbers that are less than 0.05% of the cumulative run for those days.
...
```{r risk05-situk, fig.cap="The percent of the run that will be missed at a given risk level, e.g., 3\\% of the run will be missed 5\\% of the time using a five day 0.05\\% rule for the Situk River."}
