...
All associated files, data, and code are located at https://github.com/commfish/weiRends. This work was originally developed by Scott Raborn. 
...
Based upon all years of data, the date that 90% of the escampent passes the weir 95% of the time is `r tbls_egegik$run_through$date`. 
