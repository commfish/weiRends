...
Using a 0.05% rule proved to adjust the median removal date (Table \@ref(tab:remove05-situk)) substantially improved the chance that the majority of the run was observed (Table \@ref(tab:chance05-situk)).
...
```{r risk05-situk, fig.cap="The percent of risk that a given \\% of the run is missed, e.g., 5\\% of the run will be missed 7\\% of the time using a five day 0.05\\% rule for the Situk River."}
