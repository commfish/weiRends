...
Note that there is a 50% chance of capturing 94-94% of the run, which is slightly lower than the expected 95% based upon the mean passage date stated previously.
