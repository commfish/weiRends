...
```{r pred-decade, fig.cap="Predicted cumulative escapements by year and decade for the Egegik River. Filled circles indicate 95\\% of the run has passed the weir. The vertical line is the mean date that 95\\% of the run has passed the weir."}
...
```{r pred-decade-koot, fig.cap="Predicted cumulative escapements by year and decade for the Chilkoot River. Filled circles indicate 95\\% of the run has passed the weir. The vertical line is the mean date that 95\\% of the run has passed the weir."}
