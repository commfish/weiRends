...
A cumulative run is predicted from the selected model and then this is converted into the number of estimated fish past the weir for a given day.
...
As the original workup was for the Egegik River this analysis was repeated to reflect changes between the current code and the provided spreadsheet.
...
```{r pred, fig.cap="Predicted cumulative escapements by year and decade for the Egegik River. Filled circles indicate 95\\% of the run has passed the weir. The vertical line is the mean date that 95\\% of the run has passed the weir."}
...
Based upon median removal dates presented in Table \@ref(tab:remove-eg), there is a 95% chance of capturing 93-96% of the total run, depending on which weir removal rule (# of days) is implemented (Table \@ref(tab:chance-eg)).
...
None of the parameter estimates have substantial error bars (Figure \@ref(fig:param-koot)) and the models converged for all years.
...
```{r pred-koot, fig.cap="Predicted cumulative escapements by year and decade for the Chilkoot River. Filled circles indicate 95\\% of the run has passed the weir. The vertical line is the mean date that 95\\% of the run has passed the weir."}
...
Using a 0.05% rule proved to adjust the median removal date (Table \@ref(tab:remove05-koot)) and substantially improved the chance that the majority of the run was observed (Table \@ref(tab:chance05-koot)).
...
```{r pred-decade-situk, fig.cap="Predicted cumulative escapements by year and decade for the Situk River. Filled circles indicate 95\\% of the run has passed the weir. The vertical line is the mean date that 95\\% of the run has passed the weir."}
