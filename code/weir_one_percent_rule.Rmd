...
Table 1: The percent of the run that is caught at a given risk level. The data from this table are plotted in figure 3 as the percent of missed run at a given level of risk
```{r table1, echo=FALSE}
...
Table 5: The percent of the run that is caught at a given risk level. The data from this table are plotted in figure 6 as the percent of missed run at a given level of risk.
```{r table5, echo=FALSE}
...
Table 7: The percent of missed run at a given level of risk (the inverse of table 5). 
```{r table7, echo=FALSE}
