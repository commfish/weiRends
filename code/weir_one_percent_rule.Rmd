...
Table 1: The percent of the run that is caught at a given risk level. 
```{r table1, echo=FALSE}
...
Table 3: The percent of missed run at a given level of risk (the inverse of table 1). The data from this table is shown in figure 3.
```{r table3, echo=FALSE}
...
Figure 3: The percent of missed run at a given level of risk. The data are shown in table 3.
  \pagebreak
...
Table 5: The percent of the run that is caught at a given risk level. 
```{r table5, echo=FALSE}
...
Figure 6: The percent of missed run at a given level of risk. The data are shown in table 3.
  \pagebreak
