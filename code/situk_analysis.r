...
# take model1(gompertz) deviance minus model2(logistic); add the ones up that are <0, and then
# divide that count by the total number of years (i.e., looking for the model with the smaller deviance)
# https://github.com/cran/nls.multstart (deviance is the same as residual sum of squares in non-linear regression)
# get parameters
...
f_plot_output_situk(preds) # fitted_plot.png
...
f_pred1999_plot_situk(preds, run_through) # pred_plot1990.png
f_pred2000_plot_situk(preds, run_through) # pred_plot1991.png
f_pred2010_plot_situk(preds, run_through) # pred_plot2001.png
