...
The percent of the run that would be missed is further examined in Table \@ref(tab:risk2). Overall, this run is well represented by the 1% rule with a low potential for missing 5% or more of the run, and a moderate risk of missing only 1% of the total run.
...
Using a 0.05% rule proved to adjust the median removal date (Table \@ref(tab:remove05-situk)) and improved the chance that the majority of the run was observed (Table \@ref(tab:chance05-situk)).
...
Overall, this run is well represented by the 0.05% rule with a reasonable risk for missing 5% or more of the run, and a moderate risk of missing only 1% of the total run.
