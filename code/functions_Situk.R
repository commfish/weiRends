f_plot_output_situk <- function (preds){ # fitted cumulative sum versus raw and diff by year
...
f_pred1999_plot_situk <- function(preds, run_through, perc = 0.95){ #change perc to 0.90 for alt run
...
f_pred2000_plot_situk <- function(preds, run_through){
  run_through = run_through$hard_date
...
f_pred2010_plot_situk<- function(preds, run_through){ #change perc to 0.90 for alt run
  run_through = run_through$hard_date
